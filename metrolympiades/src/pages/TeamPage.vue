...
/* Liste des membres (similaire à leaderboard-list) */
.team-list {
  width: 80%; /* Largeur identique à LeaderboardPage */
  max-width: 600px;
  margin: 0 auto;
  margin-top: 15px;
  display: flex;
...
/* Élément individuel (similaire à leaderboard-item) */
.team-item {
  display: flex;
  align-items: center;
  padding: 10px;
...
/* Nom des membres (similaire à team-name dans leaderboard) */
.team-name {
  flex: 1;
  font-size: 16px;
  color: #ffffff;
...
.icon-button.remove-button {
  ...
  border: none;
  cursor: pointer;
  color: #ff4d4d; /* Rouge pour supprimer */
  display: flex;
  align-items: center;
}

.icon-button.remove-button:hover {
  color: #ff1a1a; /* Rouge vif au survol */
}

/* Ajouter un membre */
.add-member {
  display: flex;
  gap: 10px; /* Espacement entre champ texte et bouton */
  margin-top: 20px;
}
